            ...
            if (currentVersion) {
                ...
                const newVersion = await tx.documentVersion.create({
                    data: {
                        ...
                        fileName: currentVersion.contentMode === "FILE" ? currentVersion.fileName : null,
                        fileSize: currentVersion.contentMode === "FILE" ? currentVersion.fileSize : null,
                        mimeType: currentVersion.contentMode === "FILE" ? currentVersion.mimeType : null,
                        storageKey: currentVersion.contentMode === "FILE" ? currentVersion.storageKey : null,
                        contentMode: currentVersion.contentMode,
